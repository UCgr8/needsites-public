  ...
  return <>
      ...
      <section className="relative min-h-screen liquid-mesh-bg text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-needsites-orange/4 rounded-full mix-blend-multiply filter blur-3xl animate-liquid-float" style={{
            animationDelay: '3s'
          }}></div>
          <div className="absolute bottom-1/3 left-1/3 w-72 h-72 bg-needsites-blue/3 rounded-full mix-blend-multiply filter blur-3xl animate-liquid-float" style={{
            animationDelay: '6s'
          }}></div>
        </div>
          ...
          <div className="text-center w-full">
            <div className="stagger-fade-1">
              <h1 className="text-6xl md:text-8xl font-bold mb-8 leading-tight liquid-gradient-text drop-shadow-2xl">
                Buy or Rent
                <span className="block gradient-text animate-gradient bg-gradient-to-r from-needsites-orange via-yellow-300 to-needsites-orange bg-[length:200%_auto]">PremiDum Domains</span>
              </h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center stagger-fade-3">
              <Link to="/category/all" className="liquid-glass-button bg-gradient-to-r from-needsites-blue to-needsites-dark-blue hover:from-needsites-dark-blue hover:to-needsites-blue text-lg font-semibold group">
                <span className="relative z-10">Browse All Domains</span>
              </Link>
              <Link to="/categories" className="liquid-glass-button bg-gradient-to-r from-needsites-orange to-needsites-orange-dark hover:from-needsites-orange-dark hover:to-needsites-orange text-lg font-semibold group">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="text-center p-10 glass-card rounded-3xl magnetic-hover animate-scale-in stagger-2 group">
              <div className="w-20 h-20 bg-gradient-to-br from-needsites-orange/20 to-needsites-orange/10 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform floating" style={{
                animationDelay: '1s'
              }}>
            ...
            <div className="text-center p-10 glass-card rounded-3xl magnetic-hover animate-scale-in stagger-3 group">
              <div className="w-20 h-20 bg-gradient-to-br from-green-500/20 to-green-400/10 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform floating" style={{
                animationDelay: '2s'
              }}>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {featuredDomains.map((domain, index) => <div key={domain.name} className={`glass-card rounded-3xl p-10 magnetic-hover animate-scale-in stagger-${index + 1} group relative overflow-hidden`}>
                {/* Shimmer Effect */}
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link to={`/domain/${domain.name}`} className="px-6 py-3 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold rounded-xl btn-magnetic glow-blue group-hover:scale-105 transition-transform">
                      View Details
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-32 bg-background relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {CATEGORIES.map((category, index) => <Link key={category.slug} to={`/category/${category.slug}`} className={`group glass-card rounded-3xl p-10 magnetic-hover animate-scale-in stagger-${index % 3 + 1} relative overflow-hidden`}>
                {/* Shimmer Effect */}
          ...
          <div className="text-center mt-16 animate-fade-in-up stagger-4">
            <Link to="/categories" className="px-12 py-6 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-bold rounded-2xl btn-magnetic glow-blue text-xl relative overflow-hidden group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[{
              ...
              rating: 5
            }].map((testimonial, index) => <div key={index} className="bg-card rounded-2xl p-8 border border-border hover:shadow-lg transition-shadow">
                <div className="mb-6">
                  <div className="flex items-center gap-1 mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => <div key={i} className="w-5 h-5 bg-yellow-400 rounded-full"></div>)}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[{
              ...
              desc: "SSL encrypted & escrow protected transactions"
            }, {
              icon: "⭐",
              title: "Premium Quality",
              desc: "Hand-picked domains with verified ownership"
            }, {
              icon: "🚀",
              title: "Fast Process",
              desc: "Complete domain transfers in 5-7 business days"
            }, {
              icon: "💬",
              title: "Expert Support",
              desc: "Dedicated customer success team available 24/7"
            }].map((feature, index) => <div key={index} className="text-center bg-card rounded-xl p-6 border border-border">
      ...
      <section className="py-32 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white relative overflow-hidden">
        ...
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-white/5 rounded-full blur-3xl animate-blob" style={{
          animationDelay: '3s'
        }}></div>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up stagger-2">
            <Link to="/category/all" className="group px-12 py-6 glass-card text-white font-bold rounded-2xl btn-magnetic text-xl relative overflow-hidden">
            ...
            <Link to="/contact" className="group px-12 py-6 bg-gradient-to-r from-needsites-orange to-needsites-orange-dark text-white font-bold rounded-2xl btn-magnetic glow-orange text-xl relative overflow-hidden">
