      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-gradient-to-r from-needsites-blue to-needsites-dark-blue rounded-3xl p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-needsites-blue font-semibold rounded-xl hover:bg-blue-50 transition-colors"
            >
              <Mail className="w-5 h-5" />
              Contact Support
            </Link>
            <a
              href="mailto:email@needsites.com"
              className="inline-flex items-center gap-2 px-8 py-4 bg-needsites-orange text-white font-semibold rounded-xl hover:bg-needsites-orange-dark transition-colors"
            >
            ...
            <Link 
              to="/about" 
              className="inline-flex items-center gap-2 px-6 py-4 border-2 border-white text-white font-semibold rounded-xl hover:bg-white/10 transition-colors"
            >
              About NeedSites
            </Link>
          </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link
              to="/category/other"
              className="group bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-all duration-200 hover:border-primary/20"
            >
